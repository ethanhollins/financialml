...
class GeneticPlanModel(GA.GeneticAlgorithmModel):
	...
	def getOutput(self, X):
		...
		x[:,:,4] = np.round(x[:,:,4] * ((50.0-15.0) + 15.0))
	...
	@jit
	def run(i, j, positions, charts, result, data, stats, threshold, out, plan, sl):
		# Performance Measuring
		multi = pow(i / charts.shape[1], 2)
