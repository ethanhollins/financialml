...
df = dl.get(Constants.GBPUSD, Constants.TEN_MINUTES, start=dt.datetime(2019,8,1), end=dt.datetime(2020,2,1))
...
ga.saveBest(10, 'v1.7.0_1_old', {'mean': float(mean), 'std': float(std)})
