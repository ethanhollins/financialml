...
class GeneticPlanModel(GA.GeneticAlgorithmModel):
	...
	def __str__(self):
		return  ' (Train) Perf: {:.2f}  Wins: {:.0f}  P Wins: {:.0f}  Losses: {:.0f}\n' \
			...
			self.getPerformance(self.train_results, training=True), self.train_results[1], self.train_results[2], self.train_results[3],
